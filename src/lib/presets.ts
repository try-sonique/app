...
const FR = {
  ...
  welcomePiano: 'Piano',
  welcomePianoHint: 'Clavier',
  welcomeGuitar: 'Guitare',
  welcomeBass: 'Basse',
  welcomeGuitarHint: '6 cordes',
  welcomeBassHint: '4 cordes',
  welcomeInstrumentsLead: 'Piano, guitare ou basse.',
  instrumentEyebrow: 'Ton instrument',
  instrumentTitle: 'Quel instrument joues-tu ?',
  instrumentLead: 'Un choix. Tu n’es pas coincé.',
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  welcomePiano: 'Piano',
  welcomePianoHint: 'Keyboard',
  welcomeGuitar: 'Guitar',
  welcomeBass: 'Bass',
  welcomeGuitarHint: '6 strings',
  welcomeBassHint: '4 strings',
  welcomeInstrumentsLead: 'Piano, guitar or bass.',
  instrumentEyebrow: 'Your instrument',
  instrumentTitle: 'Which instrument do you play?',
  instrumentLead: 'One choice. You are not stuck.',
