...
const FR = {
  ...
  loginLead: 'Un seul compte. Google ou email — pas trois portes.',
  signupLead: 'Même compte. Pseudo pour Aria, email pour le retrouver, ou Google.',
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  haveAccount: 'Sign in',
  loginLead: 'One account. Google or email — not three doors.',
  signupLead: 'Same account. Display name for Aria, email to come back, or Google.',
