...
const FR = {
  ...
  historyLead: 'Retrouve tes prises et relis les retours d’Aria. Ouvre une session pour revoir le détail.',
...
const EN: { [K in keyof typeof FR]: string } = {
  ...
  historyLead: 'Replay your takes and reread Aria’s notes. Open a session to see the full report.',
