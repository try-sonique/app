...
const FR = {
  ...
  welcomeBass: 'Basse',
  welcomeGuitarHint: 'Ton accord, ta prise.',
  welcomeBassHint: 'Ton accord, ta prise.',
  welcomeInstrumentsLead: 'Piano, guitare ou basse.',
  instrumentEyebrow: 'Ton instrument',
  instrumentTitle: 'Quel est ton instrument ?',
  instrumentLead: 'Piano, guitare ou basse.',
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  welcomeBass: 'Bass',
  welcomeGuitarHint: 'Your tuning, your take.',
  welcomeBassHint: 'Your tuning, your take.',
  welcomeInstrumentsLead: 'Piano, guitar or bass.',
  instrumentEyebrow: 'Your instrument',
  instrumentTitle: 'What is your instrument?',
