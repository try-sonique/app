...
const FR = {
  ...
  login: 'Connexion',
  loginHint: 'J’ai déjà un compte — email + mot de passe.',
  firstTime: 'Créer un compte',
  firstTimeHint: 'Première fois — prénom, email et mot de passe.',
  ...
  passwordHint: 'Au moins 6 caractères (lettres ou chiffres, pas de règle spéciale).',
  ...
  signupLead:
    'Prénom, email et mot de passe sont requis. Le reste est facultatif — ton compte est sauvegardé de façon sécurisée.',
  firstName: 'Prénom',
  lastName: 'Nom',
...
const EN: { [K in keyof typeof FR]: string } = {
  ...
  login: 'Log in',
  loginHint: 'I already have an account — email + password.',
  firstTime: 'Create an account',
  firstTimeHint: 'First time — first name, email and password.',
  loginEyebrow: 'Log in',
  ...
  passwordHint: 'At least 6 characters (letters or numbers — no special rules).',
  ...
  signupLead:
    'First name, email and password are required. The rest is optional — your account is saved securely.',
